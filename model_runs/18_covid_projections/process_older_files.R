...
model_run_id <- 75
file_location_base <- "https://raw.githubusercontent.com/youyanggu/covid19_projections/master/projections/2020-04-04/"
...
## check data
ggplot(additional_outputs[which(additional_outputs$location == "Sweden" & additional_outputs$output_id == 4),],
       aes(x = date, y = value)) +
  geom_line(size = 1) +
