...
ui <- navbarPage("COVID Model Inventory", id = "tabs",
                 ...
                 tabPanel("Overview",
                          mainPanel(
                            ...
                            p(strong("This site is updated monthly (last update on July 15, 2020), and likely does not display the most recent results available for any given model.")))),
                          ...
                          mainPanel(
                            navlistPanel("Select model:",
                                        ...
                                        tabPanel("Auquan Model",
                                                 ...
                                                 p(tags$b("Most recent data update in Model Inventory:"), "July 5, 2020"),
                                                 hr()
                ...
                tabPanel("COVID Act Now Model",
                         ...
                         hr(),
                           ...
                           p(tags$b("Most recent data update in Model Inventory:"), "July 14, 2020"),
                         hr()
                ...
                tabPanel("COVID19-projections.com",
                         ...
                         p(tags$b("Temporal and geographic resolution:"), "daily estimates, per US state and for selected countries"),
                         hr(),
                ...
                ###################################################################################
                            ...
                            tabPanel("IHME COVID-19 Model",
                                     ...
                                     p(tags$b("Key assumptions:") ,
                                       ...
                                       p(tags$b("Most recent data update in Model Inventory:"), "July 11, 2020"),
                                       hr()
                                     )),
                ...
                tabPanel("MIT DELPHI Model",
                         ...
                         p(tags$b("Key assumptions:") ,
                           ...
                           p(tags$b("Most recent data update in Model Inventory:"), "July 15, 2020"),
                           hr()
                         )),
                ###################################################################################
